...
export default async function PublicSolvencyPage({
  ...
  const desktop = (
    <DesktopShell maxWidth={1100}>
      <div className="flex items-center justify-between pb-8 border-b border-[#DCDCDC]">
        <div>
          <Link href="/" className="text-[13px] font-medium text-[#7C7C7C] hover:text-[#0A0A0A]">
            ← All businesses
          </Link>
          <h1 className="text-[32px] font-semibold text-[#0A0A0A] mt-1">{displayName}</h1>
          <p className="text-[13px] text-[#7C7C7C] mt-1">
            Live public solvency · block {indexedAtBlock.toLocaleString("en-US")}
          </p>
        </div>
        <StatusChip
      ...
      <p className="text-[15px] text-[#5A5A5A] leading-relaxed max-w-[760px] pt-6">
      ...
      <div className="grid grid-cols-[1.1fr_0.9fr] gap-10 pt-8">
          ...
          <ClaySlab hero className="p-6 flex flex-col gap-4">
            ...
            {recentHistory.length > 0 && (
              <div className="w-full flex flex-col gap-2 pt-2">
                ...
                <div className="w-full h-28 bg-[#EFEFEF] rounded-xl p-3 relative flex items-end justify-between border border-[#DCDCDC] overflow-hidden">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <h2 className="text-[18px] font-semibold text-[#0A0A0A]">Account class breakdown</h2>
          ...
          <div className="flex flex-col gap-3">
            <h2 className="text-[18px] font-semibold text-[#0A0A0A]">Unlock history</h2>
            {unlocks.length === 0 && (
      ...
      <footer className="mt-10 pt-8 border-t-2 border-[#0A0A0A]">
        <p className="text-[15px] leading-[24px] font-normal text-[#0A0A0A] max-w-[760px]">
